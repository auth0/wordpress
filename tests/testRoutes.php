...
class TestRoutes extends TestCase {
	...
	public function testThatOauthConfigIsCorrect() {
		self::$wp->set( 'a0_action', 'oauth2-config' );
		...
		self::$wp->set( 'a0_action', null );
		self::$wp->set( 'pagename', 'oauth2-config' );
	...
	public function testThatCooFallbackIsCorrect() {
		...
		self::$wp->set( 'a0_action', 'coo-fallback' );
