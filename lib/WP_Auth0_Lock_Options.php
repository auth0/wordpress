...
class WP_Auth0_Lock_Options {
    ...
    public function get_sso_options() {
        ...
        $extraOptions["scope"] = "openid update:clients update:connections create:connections create:rules delete:rules update:users";
    ...
    public function get_lock_options() {
        ...
        $extraOptions["authParams"]["scope"] = "openid update:clients update:connections create:connections create:rules delete:rules update:users";
