...
class WP_Auth0_Settings_Section {
    ...
    public static function init_menu(){
        ...
        add_submenu_page('wpa0', __('JWT Auth integration', WPA0_LANG), __('JWT Auth integration', WPA0_LANG), 'manage_options', 'wpa0-jwt-auth', array('WP_Auth0_configureJWTAUTH', 'render_settings_page') );
    }
}
